package com.tom.stockbridge.network;
...
import com.tom.stockbridge.IDataReceiver;
import com.tom.stockbridge.StockBridge;

public class NetworkHandler {
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
			ResourceLocation.tryBuild(StockBridge.MODID, "main"),
			() -> PROTOCOL_VERSION,
	...
	public static void init() {
		...
		StockBridge.LOGGER.info("Initilaized Network Handler");
	}
